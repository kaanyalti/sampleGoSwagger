...
import (
	...
	"simpleServer/restapi/operations"
	"simpleServer/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../simpleServer --name TodoList --spec ../swagger.yml

var exampleFlags = struct {
	Example1  string `long:"example" description:"Sample for showing how to configure cmd-line flags"`
